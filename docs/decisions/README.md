...
| [0006](0006-capability-manifest-and-three-layer-availability.md) | Model the provider boundary as a declared capability manifest with three-layer availability | proposed | 2026-09-13 |
